...
import homework8.Book;
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            System.out.println("war.getAuthors().getName() = " + lev.getName());
            System.out.println("war.getAuthors().getSurname() = " + lev.getSurname());
            ...
            System.out.println("souls.getAuthors().getName() = " + nik.getName());
            System.out.println("souls.getAuthors().getSurname() = " + nik.getSurname());
